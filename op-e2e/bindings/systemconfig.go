...
//
// Solidity: function l2ETHToken() view returns(address addr_)
func (_SystemConfig *SystemConfigCaller) L2ETHToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "l2ETHToken")
...
//
// Solidity: function l2ETHToken() view returns(address addr_)
func (_SystemConfig *SystemConfigSession) L2ETHToken() (common.Address, error) {
	return _SystemConfig.Contract.L2ETHToken(&_SystemConfig.CallOpts)
}

// L2ETHToken is a free data retrieval call binding the contract method 0xe870a594.
//
// Solidity: function l2ETHToken() view returns(address addr_)
func (_SystemConfig *SystemConfigCallerSession) L2ETHToken() (common.Address, error) {
	return _SystemConfig.Contract.L2ETHToken(&_SystemConfig.CallOpts)
}
...
// Initialize is a paid mutator transaction binding the contract method 0x0220e34f.
//
// Solidity: function initialize(address _owner, uint256 _overhead, uint256 _scalar, bytes32 _batcherHash, uint64 _gasLimit, address _unsafeBlockSigner, (uint32,uint8,uint8,uint32,uint32,uint128) _config, address _batchInbox, (address,address,address,address,address,address,address,address) _addresses) returns()
