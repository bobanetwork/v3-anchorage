...
func (_L1StandardBridge *L1StandardBridgeTransactor) SetSuperchainConfig(opts *bind.TransactOpts, _superchainConfig common.Address) (*types.Transaction, error) {
	return _L1StandardBridge.contract.Transact(opts, "setSuperchainConfig", _superchainConfig)
}

// SetSuperchainConfig is a paid mutator transaction binding the contract method 0xe23754da.
//
// Solidity: function setSuperchainConfig(address _superchainConfig) returns()
func (_L1StandardBridge *L1StandardBridgeSession) SetSuperchainConfig(_superchainConfig common.Address) (*types.Transaction, error) {
	return _L1StandardBridge.Contract.SetSuperchainConfig(&_L1StandardBridge.TransactOpts, _superchainConfig)
}

// SetSuperchainConfig is a paid mutator transaction binding the contract method 0xe23754da.
//
// Solidity: function setSuperchainConfig(address _superchainConfig) returns()
func (_L1StandardBridge *L1StandardBridgeTransactorSession) SetSuperchainConfig(_superchainConfig common.Address) (*types.Transaction, error) {
	return _L1StandardBridge.Contract.SetSuperchainConfig(&_L1StandardBridge.TransactOpts, _superchainConfig)
}
