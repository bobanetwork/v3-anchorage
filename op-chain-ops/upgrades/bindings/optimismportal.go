...
func (_OptimismPortal *OptimismPortalTransactor) SetL2ETHToken(opts *bind.TransactOpts, _token common.Address) (*types.Transaction, error) {
	return _OptimismPortal.contract.Transact(opts, "setL2ETHToken", _token)
}

// SetL2ETHToken is a paid mutator transaction binding the contract method 0xa4e73556.
//
// Solidity: function setL2ETHToken(address _token) returns()
func (_OptimismPortal *OptimismPortalSession) SetL2ETHToken(_token common.Address) (*types.Transaction, error) {
	return _OptimismPortal.Contract.SetL2ETHToken(&_OptimismPortal.TransactOpts, _token)
}

// SetL2ETHToken is a paid mutator transaction binding the contract method 0xa4e73556.
//
// Solidity: function setL2ETHToken(address _token) returns()
func (_OptimismPortal *OptimismPortalTransactorSession) SetL2ETHToken(_token common.Address) (*types.Transaction, error) {
	return _OptimismPortal.Contract.SetL2ETHToken(&_OptimismPortal.TransactOpts, _token)
}
