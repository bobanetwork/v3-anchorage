...
func (_L1CrossDomainMessenger *L1CrossDomainMessengerTransactor) SendMintETHERC20Message(opts *bind.TransactOpts, _l1Token common.Address, _l2Token common.Address, _sender common.Address, _to common.Address, _value *big.Int, _gasLimit uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendMintETHERC20Message(address _l1Token, address _l2Token, address _sender, address _to, uint256 _value, uint64 _gasLimit) returns(bytes)
func (_L1CrossDomainMessenger *L1CrossDomainMessengerSession) SendMintETHERC20Message(_l1Token common.Address, _l2Token common.Address, _sender common.Address, _to common.Address, _value *big.Int, _gasLimit uint64) (*types.Transaction, error) {
...
//
// Solidity: function sendMintETHERC20Message(address _l1Token, address _l2Token, address _sender, address _to, uint256 _value, uint64 _gasLimit) returns(bytes)
func (_L1CrossDomainMessenger *L1CrossDomainMessengerTransactorSession) SendMintETHERC20Message(_l1Token common.Address, _l2Token common.Address, _sender common.Address, _to common.Address, _value *big.Int, _gasLimit uint64) (*types.Transaction, error) {
	return _L1CrossDomainMessenger.Contract.SendMintETHERC20Message(&_L1CrossDomainMessenger.TransactOpts, _l1Token, _l2Token, _sender, _to, _value, _gasLimit)
}
